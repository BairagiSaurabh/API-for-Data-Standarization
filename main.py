...
class Data_Preprocess():
    ...
    def run(self):
        ...
        # Change Datatype
        input_change_datatype = str(input("Do you want to change the datatype? (Y/n): "))
        if input_change_datatype.lower() == "y":
            column_name = input("Provide the list of column names to change datatype: ")
            new_datatype = input("Provide the list of datatypes to be changed in same order as columns above "
                                 "(int,float,datetime,str,bool): ")
